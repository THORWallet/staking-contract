...
describe("TGT Staking", function () {
    ...
    describe("should allow deposits and withdraws", function () {
        ...
        it("pending reward should be updated for all stakers when there is a new deposit of reward tokens and staking multiplier is 0.5x", async function () {
            ...
            expect(await tgtStaking.pendingReward(bob.address, rewardToken.address)).to.be.equal(utils.parseEther("34.68"));
        ...
        it.only("Staking rewards redistribution example", async function () {
            ...
            expect(await tgtStaking.pendingReward(alice.address, rewardToken.address)).to.be.equal(utils.parseEther("400"));
            ...
            expect(await rewardToken.balanceOf(alice.address)).to.be.equal(utils.parseEther("400"));
            expect(await rewardToken.balanceOf(bob.address)).to.be.equal(utils.parseEther("300"));
